    ...
    render() {
        return (
            <div className="fd2">
                ...
                <img className="en-bg" alt="alt" src="./images/lang-bg.png" />
                <img className="en-flag" alt="alt" src="./images/fd2/en-flag.png" />
                <img className="en en-text-blue hidden" alt="alt" src="./images/fd2/en.png" />
                <img className="en en-text-white" alt="alt" src="./images/fd2/en-white.png" />
                ...
                <img className="cn-bg hidden" alt="alt" src="./images/lang-bg.png" />
                <img className="cn-flag" alt="alt"src="./images/fd2/cn-flag.png" />
                <img className="cn cn-text-blue" alt="alt" src="./images/fd2/cn.png" />
                <img className="cn cn-text-white hidden" alt="alt" src="./images/fd2/cn-white.png" />
                ...
                <div uk-scrollspy="target: > img; cls: uk-animation-slide-left; delay: 150">
                    <img className="headline-mahanakhon" alt="alt" src="./images/fd2/headline-mahanakhon.png" />
                    <img className="text-1" alt="alt" src="./images/fd2/text-1.png" />
                    <img className="headline-mahanakhon-highlight" alt="alt" src="./images/fd2/headline-mahanakhon-highlight.png" />
                    <img className="text-2" alt="alt" src="./images/fd2/text-2.png" />
                </div>
            
                <div uk-scrollspy="target: > img; cls: uk-animation-scale-up; delay: 600;">
                    <img className="lev-78" alt="alt" src="./images/fd2/lev-78.png" />
                </div>
                ...
                <img className="text-3" uk-parallax="x: 600,0; viewport: 0.5;" alt="alt" src="./images/fd2/text-3.png" />
                <img className="text-4" uk-parallax="x: -600,0; viewport: 0.5;" alt="alt" src="./images/fd2/text-4.png" />
                <img className="text-5" uk-parallax="x: 600,0; viewport: 0.5;" alt="alt" src="./images/fd2/text-5.png" />
                <img className="text-6" uk-parallax="x: -600,0; viewport: 0.5;" alt="alt" src="./images/fd2/text-6.png" />
                ...
                <img className="lev-74" uk-parallax="opacity: 0,1,1; scale: 0.5,1.4,1; viewport: 0.5;" alt="alt" src="./images/fd2/lev-74.png" />
                <img className="text-7" uk-parallax="opacity: 0,1; scale: 0.5,1; viewport: 0.5;" alt="alt" src="./images/fd2/text-7.png" />
                ...
                <img className="text-8" uk-parallax="x: -600,0; opacity: 0,1; viewport: 0.5;" alt="alt" src="./images/fd2/text-8.png" />
            
                <img className="text-9" uk-parallax="x: 600,0; viewport: 0.5;" alt="alt" src="./images/fd2/text-9.png" />
                <img className="text-10" uk-parallax="x: -600,0; viewport: 0.5;" alt="alt" src="./images/fd2/text-10.png" />
                ...
                <img className="lev-1" uk-parallax="opacity: 0,1,1; scale: 0.5,1.4,1; viewport: 0.5;" alt="alt" src="./images/fd2/lev-1.png" />
                ...
                <img className="text-11" uk-parallax="x: 600,0; viewport: 1;" alt="alt" src="./images/fd2/text-11.png" />
                <img className="text-12" uk-parallax="x: -600,0; viewport: 1;" alt="alt" src="./images/fd2/text-12.png" />
